...
exports.WrappedNativeTokenSymbols = exports.NativeTokenSymbols = exports.SmartTokens = exports.Holders = exports.Tokens = exports.GENERIC_ADDR2 = exports.GENERIC_ADDR1 = exports.GIFTER_ADDRESS = void 0;
const smart_tokens_1 = require("../tests/smart-tokens");
const constants_1 = require("../src/constants");
exports.GIFTER_ADDRESS = '0xb22fC4eC94D555A5049593ca4552c810Fb8a6d00';
exports.GENERIC_ADDR1 = '0xbe9317f6711e2da074fe1f168fd9c402bc0a9d1b';
exports.GENERIC_ADDR2 = '0x230a1ac45690b9ae1176389434610b9526d2f21b';
exports.Tokens = {
    [constants_1.Network.MAINNET]: {
        ...
        USDC: {
            ...
            decimals: 6,
            symbol: 'USDC',
            addBalance: smart_tokens_1.balancesFn,
        ...
        WETH: {
            ...
            decimals: 18,
            addBalance: smart_tokens_1.balanceOfFn,
            addAllowance: smart_tokens_1.allowanceFn,
        },
        PSP: {
    ...
    [constants_1.Network.POLYGON]: {
        ...
        USDCe: {
            ...
            decimals: 6,
            addBalance: smart_tokens_1._balancesFn,
            addAllowance: smart_tokens_1._allowancesFn,
        },
        TEL: {
        ...
        MATIC: { address: constants_1.ETHER_ADDRESS, decimals: 18 },
        mUSD: {
    ...
    [constants_1.Network.FANTOM]: {
        FTM: { address: constants_1.ETHER_ADDRESS, decimals: 18 },
        SOLID: {
    ...
    [constants_1.Network.BSC]: {
        ...
        BNB: { address: constants_1.ETHER_ADDRESS, decimals: 18 },
        bBTC: {
    ...
    [constants_1.Network.AVALANCHE]: {
        ...
        AVAX: { address: constants_1.ETHER_ADDRESS, decimals: 18 },
        aETH: {
    ...
    [constants_1.Network.ARBITRUM]: {
        ...
        ETH: { address: constants_1.ETHER_ADDRESS, decimals: 18 },
        USDCe: {
        ...
        USDC: {
            ...
            decimals: 6,
            symbol: 'USDC',
            addBalance: smart_tokens_1.balanceAndBlacklistStatesFn,
            addAllowance: smart_tokens_1.allowedFn,
        },
        SUSHI: {
...
exports.SmartTokens = Object.keys(exports.Tokens).reduce((acc, _network) => {
    const network = parseInt(_network, 10);
    acc[+network] = Object.keys(exports.Tokens[network]).reduce((_acc, tokenName) => {
        const token = exports.Tokens[network][tokenName];
        if (token.addAllowance && token.addBalance) {
            _acc[tokenName] = new smart_tokens_1.SmartToken(token);
        }
        return _acc;
    }, {});
    return acc;
}, {});
exports.NativeTokenSymbols = {
    [constants_1.Network.MAINNET]: 'ETH',
    [constants_1.Network.POLYGON]: 'MATIC',
    [constants_1.Network.BSC]: 'BNB',
    [constants_1.Network.AVALANCHE]: 'AVAX',
    [constants_1.Network.FANTOM]: 'FTM',
    [constants_1.Network.ARBITRUM]: 'ETH',
    [constants_1.Network.OPTIMISM]: 'ETH',
    [constants_1.Network.BASE]: 'ETH',
};
exports.WrappedNativeTokenSymbols = {
    [constants_1.Network.MAINNET]: 'WETH',
    [constants_1.Network.POLYGON]: 'WMATIC',
    [constants_1.Network.BSC]: 'WBNB',
    [constants_1.Network.AVALANCHE]: 'WAVAX',
    [constants_1.Network.FANTOM]: 'WFTM',
    [constants_1.Network.ARBITRUM]: 'WETH',
    [constants_1.Network.OPTIMISM]: 'WETH',
    [constants_1.Network.BASE]: 'WETH',
};
//# sourceMappingURL=constants-e2e.js.map