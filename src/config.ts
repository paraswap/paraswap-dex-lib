...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x673Cab12247977A964F592274d05A754c9917036',
    ...
    executorsAddresses: {
      Executor01: '0x4FCD812DF2190A44bF771FE9Ea87649B9be56bBD',
      Executor02: '0xe14A76d98fdD13A6Ef2821B73D03F4A2DCbfFFED',
      Executor03: '0xaaa0A125acDbf60AF4018777D8e1CccF7c991355',
    },
    adapterAddresses: {
