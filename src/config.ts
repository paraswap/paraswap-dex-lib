...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x205DCBA67f86620353439429f680c4B033Bba1Bb',
    ...
    executorsAddresses: {
      Executor01: '0xee2706219F171C1f66CDa888E41318cc5C5EB6be',
      Executor02: '0x1c3Df97C4cC9aBeFc26D409989dbfFe503244676',
      Executor03: '0xFa4Ae2BE90096d409731320D8D7F79773D503e91',
    },
    adapterAddresses: {
