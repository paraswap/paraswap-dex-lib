...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x14Ce0C2785A88BC3aB22267d2cCdA3434a5238b5',
    ...
    executorsAddresses: {
      Executor01: '0xD92175E35018Ba3bD9aAF646B7F319661053980B',
      Executor02: '0x2cb11dB945A2B54171995a4b2ef3251D8838124a',
      Executor03: '0xeAfF1E07812BF6C836db98E7a80FfAf3c49DccF3',
    },
    adapterAddresses: {
  ...
  [Network.BSC]: {
    ...
    hasEIP1559: false,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0xa89E2eD6f043cB0Cea9221f532BCdc9A41580c78',
    ...
    executorsAddresses: {
      Executor01: '0x9ecA9E8529da35B456d6EcF01626f22d65B54859',
      Executor02: '0x7F8d26d69eA9282E3046e0Fdf0EE22397147602F',
      Executor03: '0xDd443B27F0d9D7ddA391393CF50c7B2e4F2c2e97',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x37C950F12BAD772e3099c80FE6892227BaD2d744',
    ...
    executorsAddresses: {
      Executor01: '0xF0af4fB8128e762b3D4395A067d8E8b7F7675f43',
      Executor02: '0x44f1DEE0489704C1144faC201E5E8724fcEe54fF',
      Executor03: '0x4f22F574A13b8ddea63441477322F268ec10b260',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
  ...
  [Network.ARBITRUM]: {
    ...
    hasEIP1559: false,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x9ecA9E8529da35B456d6EcF01626f22d65B54859',
    ...
    executorsAddresses: {
      Executor01: '0x91754b995F44DccA0B4A547FD87f5F3662552b43',
      Executor02: '0x4Ba92797D3fC29d227E7efC139d0579eD02D75D3',
      Executor03: '0x22B10A9E6c33B3d6A965Da062C46250b9bAcf73E',
    },
    adapterAddresses: {
  ...
  [Network.OPTIMISM]: {
    ...
    executorsAddresses: {
      Executor01: '0x7F8d26d69eA9282E3046e0Fdf0EE22397147602F',
      Executor02: '0xDd443B27F0d9D7ddA391393CF50c7B2e4F2c2e97',
      Executor03: '0xb90C24FE498499e95bDa6C04c7C4C77ceB9B1E31',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
