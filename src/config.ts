...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    adapterAddresses: {
      ...
      Adapter03: '0x3343a754e0f66080f459d98802b61250C2CE75F0',
      Adapter04: '0x369A2FDb910d432f0a07381a5E3d27572c876713',
      Adapter05: '0x3329dfa55A40B450952FBE0203167Ae6908E656d',
      Adapter06: '0x60e8342779319240C540954c63c7C6FCF0f3baA4',
      BuyAdapter: '0xc784592AbA9dD08A9b4A986CCEE500D557867DAE',
