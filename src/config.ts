...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x2ecE9Ab91f745C26213864573e3AEE70E6cdeFbf',
    ...
    executorsAddresses: {
      Executor01: '0xFDcA09008a5AC2Bd9CD65FDA527C188fA5CDf85C',
      Executor02: '0x143929e993D42F2E7CcAB028E7fd3D67AfC936B9',
    },
    adapterAddresses: {
