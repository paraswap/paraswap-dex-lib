...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    adapterAddresses: {
      ...
      Adapter06: '0xb2e4C561220d781D941CCd115F7EE6DE31794829',
      BuyAdapter: '0x84bEF12C9931cE12662cc9F2366b6a5029E4BD29',
      BuyAdapter02: '0x796849Efb6F45159e738246FbC65168f248DbCbd',
    },
  ...
  [Network.ARBITRUM]: {
    ...
    adapterAddresses: {
      ...
      ArbitrumAdapter03: '0x23a8fC19cd11912A74946f8569900cbDC7F4f598',
      ArbitrumBuyAdapter: '0xB53f5a0c1b21a5B81feE1872Ac032322EDE6Bc60',
    },
    uniswapV2ExchangeRouterAddress:
