...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0x7b1e6C72BCb399d435e17EE4752562581e94D2f4',
    augustusRFQAddress: '0xF3CD476C3C4D3Ac5cA2724767f269070CA09A043',
    tokenTransferProxyAddress: '0xab614d094b095e8f776a2e26210961ba7cf01b19',
  ...
  [Network.ARBITRUM]: {
    ...
    adapterAddresses: {
      ...
      ArbitrumAdapter02: '0xa003dFBA51C9e1e56C67ae445b852bdEd7aC5EEd',
  ...
  [Network.OPTIMISM]: {
    ...
    adapterAddresses: {
      OptimismAdapter01: '0xB6EBBB9f9957556Fd798927ae7c250759a235407',
