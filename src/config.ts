...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x5242cd5153399F04c816b4008925611fcD4858D2',
    ...
    executorsAddresses: {
      Executor01: '0xBf48e393a733A151B3aBB7d0385092d89599f50e',
      Executor02: '0x41d372D26D9778B535E6dc508EB174F1A2931F20',
      Executor03: '0x885c667dEA9B28abbc4f554b5A070545efad659e',
    },
    adapterAddresses: {
