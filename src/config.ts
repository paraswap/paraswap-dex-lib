...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x9F38f13f8d885A99234d13bE9228747DACD2DB06',
    ...
    executorsAddresses: {
      Executor01: '0x32Db4FfAc1809adbbFB521f81f4b89bBF72E60B7',
      Executor02: '0x87D9009bDBb2e69142940111f2C899d5231cDfd7',
      Executor03: '0xdE2333866b5B5321Efbce2D49d1BB16ff738E6E1',
    },
    adapterAddresses: {
