...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x475294f82dC4612cfedA86441304d2B42ef14db3',
    ...
    executorsAddresses: {
      Executor01: '0xAF0500d4B3f1300fbB3faD70365f4E99b467B482',
      Executor02: '0xaaFF5FC2a735023E9e6DC222966f63540AD0d25F',
      Executor03: '0x673D063431f5AE18ab5ea1f795ce0dD1653D7dce',
    },
    adapterAddresses: {
