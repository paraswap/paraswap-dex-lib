...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0xdFEf14630827Df3e2a3551C6e9Aa38Ff257687a6',
    ...
    executorsAddresses: {
      Executor01: '0xEB7b82CFF338abEF111ce33F0C55314b6359fee0',
      Executor02: '0xF97529d298E10A947F32b1352B5D86C4CcF70BD5',
      Executor03: '0xccF1680D48d85173703691de08B3F1e4AEb4Cc41',
    },
    adapterAddresses: {
