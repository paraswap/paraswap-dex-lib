...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x2dcA8B52ae675E7C64e097B3201E36e544c12f7e',
    ...
    executorsAddresses: {
      Executor01: '0xE230d502E6FA2093150E1149Bef13480b1DfF512',
      Executor02: '0xEFAA83Cdb386E13189D9098f0154a01Bba710252',
      Executor03: '0xCB94246308Bc6c2a807ACF6CA1c41a6b309123F1',
    },
    adapterAddresses: {
