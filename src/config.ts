...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x89A826A6325b0843cD335D8DC272569673aB30A8',
    ...
    executorsAddresses: {
      Executor01: '0x7A6036fB0B584444A71dc9E92425d9Dbff2536Ca',
      Executor02: '0xA24A4Ee9396d7FD5c5fbBDDaF6E951f2A86E3D28',
      Executor03: '0xdE54725fd777CC1393a4BFdE853c04139558DAB6',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
