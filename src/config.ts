...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x39Fd3F5a89570B3a19DDFA381301a3c8eD39c489',
    ...
    executorsAddresses: {
      Executor01: '0x0f694c357f2a61CadB656a9A3fDa7Eecc12888D5',
      Executor02: '0x8EA64dC63eecF82CE14055E0de4011ca10DcdaB0',
      Executor03: '0x4CF6B64e73C41F980C7EC97faD37d61148183fcF',
    },
    adapterAddresses: {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x39858675ed4F1126842902F2dA984c13BA28ae9C',
    ...
    executorsAddresses: {
      Executor01: '0x5bfEBBE51bC0791DeE87f936A7384Ad7ACA24F91',
      Executor02: '0x42D9C3E1fF342838c3DC8e2c0964D28984fC224b',
      Executor03: '0x59433b1D0De088ab9f4B410c6d287FBDAE420700',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
