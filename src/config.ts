...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x7d5B7A82f0047E83064332A88918d7067c00AA14',
    ...
    executorsAddresses: {
      Executor01: '0xaF413566b437AC2e22AAb08A9eD10B5b93DC4eB8',
      Executor02: '0x307Bf21eb68d636A15EC4AbdAb9Dc466A2aa0282',
      Executor03: '0xe34f534159701B9019845b2551072b94403B3289',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
