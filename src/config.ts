...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x7539d98fA4fE1ab511883CB9586b95f65c2B8F2C',
    ...
    executorsAddresses: {
      Executor01: '0xD8bb93e0860E9e8dce1026D2f624BB28A453f63C',
      Executor02: '0x0bba07c35E4cE5B3d0461a28DBA67E22e1ccCD99',
      Executor03: '0xd8A5f5EdE5438583C77a4B3946C54878eE02C057',
    },
    adapterAddresses: {
