...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x45b06D3291fB04d41E65BC7FDf052c76506632bb',
    ...
    executorsAddresses: {
      Executor01: '0xadf9bD56Ed91f6e4674497d721939E3aAae8Af1e',
      Executor02: '0x9994A329Fa142F9C5598726e4c5b817Bf86712A3',
      Executor03: '0xC1ED886cFCC49EFFa0e95342d9474672CfCD44CE',
    },
    adapterAddresses: {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0xD2D7e85f012542F8B7C9eF85aAF68753C43dE651',
    ...
    executorsAddresses: {
      Executor01: '0x84907c77aeC0dEcC484d1eB82ae32Dc3F11ed662',
      Executor02: '0x24e22fcb5D0dAb9F9b539c0374eFb9ca250F48B6',
      Executor03: '0x9161ecFc5275BD808704d68CF83DA66bE1338863',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
