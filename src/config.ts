...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.POLYGON]: {
    ...
    // TODO: !!! CHANGE AFTER TESTS !!!
    // TODO: !!! CHANGE AFTER TESTS !!!
    augustusAddress: '0x1987684e241c635032e514EC3d24dA32D4323Fe6',
    tokenTransferProxyAddress: '0xD60308104ef8d635f8ce1f0b7c0B73883E69d661',
    // TODO: !!! CHANGE AFTER TESTS !!!
    // TODO: !!! CHANGE AFTER TESTS !!!
    // TODO: !!! CHANGE AFTER TESTS !!!
  ...
  [Network.OPTIMISM]: {
    ...
    adapterAddresses: {
      ...
      OptimismBuyAdapter: '0xb2634B3CBc1E401AB3C2743DB44d459C5c9aA662',
    },
    uniswapV2ExchangeRouterAddress:
      '0xB41dD984730dAf82f5C41489E21ac79D5e3B61bC',
    uniswapV3EventLoggingSampleRate: 0,
