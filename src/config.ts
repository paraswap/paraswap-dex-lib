...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0xb8e76A6251F4A174fB08494a8EEd7f2ceCFe38f2',
    ...
    executorsAddresses: {
      Executor01: '0x615e13b550963a3AdBE65518b43C6e0879E3b8DC',
      Executor02: '0x312b57d627e6251be562E7d53EAE70e589F46595',
      Executor03: '0xd46f03c02941A3Ba52A2eED91AD7EB3DD40d1223',
    },
    adapterAddresses: {
