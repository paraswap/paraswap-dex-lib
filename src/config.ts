...
const baseConfigs: { [network: number]: BaseConfig } = {
  ...
  [Network.X_LAYER]: {
    network: Network.X_LAYER,
    networkName: 'X Layer',
    isTestnet: false,
    nativeTokenName: 'OKB',
    nativeTokenSymbol: 'OKB',
    wrappedNativeTokenAddress: '0xe538905cf8410324e03a5a23c1c177a474d59b2b',
    // TODO-X
    hasEIP1559: true,
    ...
    multicallV2Address: '0xBCfc39fad3118e307504F4F776BEAe2b478bA61c',
    privateHttpProvider: process.env.HTTP_PROVIDER_196,
    augustusV6Address: '0xcef4aa30328d1802c0e596fa6090a9ea36103ea3',
    adapterAddresses: {},
    executorsAddresses: {
