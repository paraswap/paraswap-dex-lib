...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x275cE6bAe30F79422d2e7bE94E29179CbCa648C3',
    ...
    executorsAddresses: {
      Executor01: '0xdfb5ac0af3B7B87E8D00083985DDABF9b7a46B22',
      Executor02: '0x26f97EBB22553ce23997593f6C2c374ACfc70672',
      Executor03: '0x448E187aa869A2291f335f534DB36Ae4B7db7E8d',
    },
    adapterAddresses: {
