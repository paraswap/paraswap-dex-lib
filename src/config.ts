...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0xa9D2093526515dF63A2729b8AE5929d0Dce4e678',
    ...
    executorsAddresses: {
      Executor01: '0x241E1dd4A08eC2DFC7233c1C96d85FB68212d155',
      Executor02: '0x0A9E9AeC875626DA266c3aa396cbcbA9c422ed16',
      Executor03: '0xd30565Ba9bC392f5f84b99348e56dAD97751151C',
    },
    adapterAddresses: {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0xFc736f39579B25BdcCcAac9BcA34D3528B88f1bE',
