...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0xDd0986916F18Be3741A74b7d14739010fbF27265',
    ...
    executorsAddresses: {
      Executor01: '0x22430Ea08E60dAfBC22d7A5E9c75bF7777f3c46f',
      Executor02: '0x555DDbD1c9ef3FE942B14eeC50fc4C4dCcAf80b7',
      Executor03: '0x378DB8631225c321a5260eD93085A2E3b1B149Fc',
    },
    adapterAddresses: {
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x66B03c76411B8Eb9CF4AdBbf00dbec4ea53E2825',
    ...
    executorsAddresses: {
      Executor01: '0x44Cd033876e2a38be7959B396D810A388A9B1fB1',
      Executor02: '0x59DA25F814DD5e64AC5450F5bb765408F139e310',
      Executor03: '0x76c00e8217De59246a986Ba72a8b886cDe2E9fE5',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
