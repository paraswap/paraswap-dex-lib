...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    adapterAddresses: {
      ...
      Adapter03: '0x745ec73855cec7249e5ff4c9dd81cc65b4d297a9',
  ...
  [Network.GOERLI]: {
    ...
    isTestnet: true,
    mainnetNetwork: Network.MAINNET,
    nativeTokenName: 'Goerli Test Token (TST)',
    nativeTokenSymbol: 'TST',
    wrappedNativeTokenAddress: '0x7af963cF6D228E564e2A0aA0DdBF06210B38615D ',
    hasEIP1559: true,
    augustusAddress: '',
    augustusRFQAddress: '',
    tokenTransferProxyAddress: '',
    multicallV2Address: '',
    privateHttpProvider: process.env.HTTP_PROVIDER_5,
    adapterAddresses: {
      RopstenAdapter01: '',
      RopstenBuyAdapter: '',
    },
