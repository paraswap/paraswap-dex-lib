...
const baseConfigs: { [network: number]: BaseConfig } = {
  [Network.MAINNET]: {
    ...
    augustusV6Address: '0x53a8BdFAC7e1e5B033cB006A9f3b2d5F33d55D91',
    ...
    executorsAddresses: {
      Executor01: '0xc7DF6d62a0769f35c77e8dDe7FD0a8B12893e8A2',
      Executor02: '0xe121FE95c104f950BF66DE5b80591bCB7ae7AD21',
      Executor03: '0xe9E03d254E312FaE021fd0074a006d91B450B8a2',
    },
    adapterAddresses: {
  ...
  [Network.BSC]: {
    ...
    hasEIP1559: false,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x01dFB3A851d17239a9DCf5b0e4B193EB51EDc503',
    ...
    executorsAddresses: {
      Executor01: '0xC353D31BeCA133ca95F2561D59CaFc07f73a8cF2',
      Executor02: '0x07e4aABA886E4d92A46a8a5E6E9bc9b3e407676E',
      Executor03: '0xfb55C8852E2Ccfe606229b0c2FEb39a0a7867dfB',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
  ...
  [Network.POLYGON]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x98D6F677e17D9E6cF155987E1dCD0C55E35eB433',
    ...
    executorsAddresses: {
      Executor01: '0x79d3b23Ac6043A9797222E9ce00703c7fE19B6Dd',
      Executor02: '0x048f844EBe3Bc8a883Bf3Cc8D54655861A0F315D',
      Executor03: '0x7168c219549d5505a4F910bE57b227DedfAed95e',
    },
    hashFlowAuthToken: process.env.API_KEY_HASHFLOW_AUTH_TOKEN || '',
    smardexSubgraphAuthToken: process.env.API_KEY_SMARDEX_SUBGRAPH || '',
    hashFlowDisabledMMs:
  ...
  [Network.AVALANCHE]: {
    ...
    hasEIP1559: true,
    augustusAddress: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
    augustusV6Address: '0x2E5CBe26f84B7e2A4835fA458FF9F25f17920504',
    ...
    executorsAddresses: {
      Executor01: '0x53a8BdFAC7e1e5B033cB006A9f3b2d5F33d55D91',
      Executor02: '0xeD63591aaF0cE546863b52D71B82cE1384e12Dde',
      Executor03: '0xC353D31BeCA133ca95F2561D59CaFc07f73a8cF2',
    },
    adapterAddresses: {
  ...
  [Network.FANTOM]: {
    ...
    executorsAddresses: {
      Executor01: '0x000000006E85dF93Da91e65184708f020e58df2c',
      Executor02: '0x000000C0ef6dBff0E689d393EDBb93702eEEf0d8',
      Executor03: '0x000000856CFe8D0625D96BD87712A074d90a9F5b',
    },
    adapterAddresses: {
