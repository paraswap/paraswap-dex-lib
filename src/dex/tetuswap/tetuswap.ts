...
import { TetuswapData, PoolState } from './types';
import { SimpleExchange } from '../simple-exchange';
import { TetuswapConfig, Adapters } from './config';

export class TetuswapEventPool extends StatefulEventSubscriber<PoolState> {
  handlers: {
...
export class Tetuswap extends SimpleExchange implements IDex<TetuswapData> {
  protected eventPools: TetuswapEventPool;
  ...
  ) // TODO: add any additional optional params to support other fork DEXes
  {
    ...
    this.eventPools = new TetuswapEventPool(
      dexKey,
      network,
      dexHelper,
      this.logger,
  ...
  async getPricesVolume(
    ...
    blockNumber: number,
    limitPools?: string[],
  ): Promise<null | ExchangePrices<TetuswapData>> {
    // TODO: complete me!
  }
