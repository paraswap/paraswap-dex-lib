...
/*
  ...
  This test script should add e2e tests for Tetuswap. The tests
  ...
  tokenB with any two highly liquid tokens on Tetuswap for the tests
  to work. If the tokens that you would like to use are not defined in 
  Tokens or Holders map, you can update the './tests/constants-e2e'

  Other than the standard cases that are already added by the template 
  it is highly recommended to add test cases which could be specific 
  to testing Tetuswap (Eg. Tests based on poolType, special tokens, 
  etc). 
...
describe('Tetuswap E2E', () => {
  const dexKey = 'Tetuswap';

  describe('Tetuswap MAINNET', () => {
    ...
    // TODO: Add any aditional test cases required to test Tetuswap
  });
});
