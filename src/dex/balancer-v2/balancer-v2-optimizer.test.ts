...
describe('BalancerV2 optimizer', () => {
  ...
  it('balancerV2Merge swapExchanges: BalancerV2-BalancerV2', () => {
        ...
        swaps: [
          {
            ...
            swapExchanges: [
              {
                exchange: 'BalancerV2',
                srcAmount: '27600000000000000000',
                destAmount: '1699967534326554574678843',
                percent: 100,
                poolAddresses: [
                  ...
                  swaps: [
                    {
                      poolId:
                        '0xcb0e14e96f2cefa8550ad8e4aea344f211e5061d00020000000000000000011a',
                      amount: '27001080000000000000',
                    },
                    {
                      poolId:
                        '0x87a867f5d240a782d43d90b6b06dea470f3f8f22000200000000000000000516',
                      amount: '598920000000000000',
                    },
                  ],
                  gasUSD: '4.791230',
                },
  ...
  it('balancerV2Merge swapExchanges: No BalancerV2', () => {
    ...
    const optimizedRate = balancerV2Merge(testRate);
    expect(optimizedRate).toStrictEqual(testRate);
  });

  it('balancerV2Merge swaps: BalancerV2-BalancerV2', () => {
    const testRate: UnoptimizedRate = _.cloneDeep(baseUnoptimizedRate);
    testRate.bestRoute = [
      {
        percent: 92,
        swaps: [
          ...
          {
            srcToken: '0xcafe001067cdef266afb7eb5a286dcfd277f3de5',
            srcDecimals: 18,
            destToken: '0xDEF171Fe48CF0115B1d80b88dc8eAB59176FEe57',
            destDecimals: 18,
            swapExchanges: [
              {
                exchange: 'BalancerV2',
  ...
  it('balancerV2Merge only one BalancerV2Fork in route', () => {
    ...
    const expectedRate: UnoptimizedRate = _.cloneDeep(testRate);
    expectedRate.bestRoute[0].swaps[0].swapExchanges[0] = {
      exchange: 'BeetsFi',
      srcAmount: '27001080000000000000',
      destAmount: '1663710383246524230443584',
      percent: 100,
