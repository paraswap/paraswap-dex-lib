...
export class E3EventPool extends StatefulEventSubscriber<PoolState> {
  handlers: {
    [event: string]: (
      event: any,
  ...
  constructor(
    ...
    logger: Logger,
    protected e3Iface = new Interface(
      '' /* TODO: Import and put here E3 ABI */,
    ...
    this.logDecoder = (log: Log) => this.e3Iface.parseLog(log);
