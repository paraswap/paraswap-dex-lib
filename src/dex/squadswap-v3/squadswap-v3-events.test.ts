...
import { SquadswapV3 } from './squadswap-v3';
  ...
  describe('BSC', () => {
    describe('WBNB -> USDT', () => {
      it('getPoolIdentifiers and getPricesVolume SELL', async function () {
        ...
        const pancakeswapV3 = new SquadswapV3(network, dexKey, dexHelper);
    ...
    describe(network, function () {
      ...
      if (testData) {
        ...
        beforeEach(async () => {
          ...
          pancakeswapV3 = new SquadswapV3(network, dexKey, dexHelper);
        });
...
function decodeReaderResult(results: any, readerIface: any, funcName: any) {
  return results.map((result: any) => {
    const parsed = readerIface.decodeFunctionResult(funcName, result);
    return parsed[0]._hex.toString(); // BigInt'i string'e dönüştürüyoruz
  });
}

async function checkOnChainPricing(
  pancakeswapV3: SquadswapV3,
  ...
  // Quoter address
  const exchangeAddress = '0x81Da0D4e1157391a22a656ad84AAb9b2716F21e0';
