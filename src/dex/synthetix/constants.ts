...
export const STATE_TTL_IN_MS = 30 * 1000;

// We are doubling the liquidity of sUSD to estimate pool liquidity because in exchange
// there are two tokens involved
export const LIQUIDITY_ESTIMATION_FACTOR = 2;
