...
/*
  ...
  This test script should add e2e tests for Bebop. The tests
  ...
  tokenB with any two highly liquid tokens on Bebop for the tests
  to work. If the tokens that you would like to use are not defined in
  Tokens or Holders map, you can update the './tests/constants-e2e'

  Other than the standard cases that are already added by the template
  it is highly recommended to add test cases which could be specific
  to testing Bebop (Eg. Tests based on poolType, special tokens,
  etc).
...
describe('Bebop E2E', () => {
  ...
  describe('Mainnet', () => {
    ...
    const tokenBAmount: string = '3000000000';
    ...
    // TODO: Add any additional test cases required to test Bebop
  });
});
