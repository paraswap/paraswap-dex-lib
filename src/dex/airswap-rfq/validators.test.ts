...
describe('AirswapRFQ Validator test', () => {
  describe('AirswapRFQ Tokens Test', () => {
    const tokens = {
      tokens: {
        WETH: {
          symbol: 'WETH',
  ...
  describe('AirswapRFQ Pairs Test', () => {
    const pairs = {
      pairs: {
        'WETH/DAI': {
          base: 'WETH',
  ...
  describe('AirswapRFQ Prices Test', () => {
    const prices = {
      prices: {
        'WETH/DAI': {
          bids: [
  ...
  describe('AirswapRFQ Blacklist Test', () => {
    const blacklist = {
      blacklist: [
  ...
  describe('AirswapRFQ Order Test', () => {
    const order = {
      order: {
        nonceAndMeta:
