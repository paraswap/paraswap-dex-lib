...
import { Uniswapv2ConstantProductPool } from './squadswap-v2-constant-product-pool';
  ...
  implements IDex<UniswapV2Data, UniswapParam | UniswapV2ParamsDirect>
{
  ...
  getDirectParamV6(
    ...
    if (!contractMethod) throw new Error(`contractMethod need to be passed`);
    if (!SquadswapV2.getDirectFunctionNameV6().includes(contractMethod!)) {
