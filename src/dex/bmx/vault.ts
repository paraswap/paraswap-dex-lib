...
export class Vault<State> extends PartialEventSubscriber<State, VaultState> {
  ...
  public mintBurnBasisPoints: bigint;
  ...
  constructor(
    ...
    this.mintBurnBasisPoints = config.mintBurnBasisPoints;
  ...
  // TODO
  buyUSDG(_token: Address, _amount: bigint): bigint {
    return 0n;
  }
