...
/*
  ...
  This test script adds tests for MWrappedM general integration
  with the DEX interface. The test cases below are example tests.
  It is recommended to add tests which cover MWrappedM specific
  logic.
...
async function checkOnChainPricing(
  ...
  // Normally you can get it from mWrappedM.Iface or from eventPool.
  ...
  const readerResult = (
    await mWrappedM.dexHelper.multiContract.methods
...
describe('MWrappedM', function () {
  ...
  describe('Mainnet', () => {
    ...
    it('getTopPoolsForToken', async function () {
      ...
      if (!newMWrappedM.hasConstantPriceLargeAmounts) {
        checkPoolsLiquidity(
          poolLiquidity,
