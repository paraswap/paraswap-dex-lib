...
describe('KyberswapElastic Event', function () {
  ...
  const blockNumbers: { [eventName: string]: number[] } = {
    ...
    ['Swap']: [
      ...
      46396563, 46396564, 46396571, 46396580, 46623582, 46623588, 46623655,
      46623711, 46623715, 46623715, 46623718, 46623907, 46625637, 46625680,
      46625685, 46625690, 46625697, 46625755, 46625790, 46625819, 46625822,
      46625914, 46631743, 46631744, 46631745, 46631782, 46631783, 46631805,
      46631812,
    ],
