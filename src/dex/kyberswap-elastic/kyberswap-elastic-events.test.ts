...
describe('KyberswapElastic Event', function () {
  ...
  const blockNumbers: { [eventName: string]: number[] } = {
    ...
    ['Swap']: [
      46368454, 46382161, 46389825, 46389828, 46389828, 46389905, 46395887,
      46396458, 46396509, 46396512, 46396541, 46396541, 46396543, 46396547,
      46396548, 46396549, 46396556, 46396557, 46396560, 46396563, 46396563,
      46396564, 46396571, 46396580, 46623582, 46623588, 46623655, 46623711,
      46623715, 46623715, 46623718,
    ],
    ...
    ['Burn']: [
      ...
      45464859, 45466043, 45692304, 45695126, 45762750, 45784950, 45798307,
      45804486, 45842608, 45912593, 45912624, 45941338, 46071378, 46072179,
      46072190,
    ],
    // // topic0 - 0x7a53080ba414158be7ec69b987b5fb7d07dee101fe85488f0853ae16239d0bde
    ['Mint']: [
      45174705, 45213105, 45229306, 45263615, 45264142, 45341174, 45425546,
      45459953, 45465078, 45474462, 45793482, 45796144, 45826502, 45940379,
      46031255, 46064396, 46075469,
    ],
    ...
    ['BurnRTokens']: [
      ...
      45174213, 45212995, 45290305, 45459729, 45464859, 45692304, 45695126,
      45730161, 45842608, 46432250,
    ],
  };
